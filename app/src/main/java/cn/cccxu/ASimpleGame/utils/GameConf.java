...
public class GameConf {
    ...
    public final static int PIECE_X_SUM = 4;

    public final  static int PIECE_Y_SUM = 4;

    public final  static int BEGIN_IMAGE_X = 4;

    public final  static int BEGIN_IMAGE_Y = 4;
